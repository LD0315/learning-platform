...
import DisappearingMessage from '../../UI/disappearingMessage/DisappearingMessage';
...
const PersonManagement = ({
    ...
    const renderAddTabContent = () => {
        const options = makeOptions(personToAdd);
    ...
    const renderRemoveTabContent = () => {
        const options = makeOptions(personToRemove);
